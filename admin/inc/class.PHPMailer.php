 ...
 /**
  ...
  private function AddAnAddress($kind, $address, $name = '') {
    ...
    if (!self::ValidateAddress($address)) {
      $this->SetError($this->Lang('Neplatná adresa').': '. $address);
      if ($this->exceptions) {
        throw new phpmailerException($this->Lang('Neplatná adresa').': '.$address);
      }
      echo $this->Lang('Neplatná adresa').': '.$address;
      return false;
    }
    if ($kind != 'ReplyTo') {
  ...
  */
  function SetLanguage($langcode = 'en', $lang_path = 'language/') {
    ...
    $PHPMAILER_LANG = array(
      ...
      'Neplatná adresa' => 'Invalid address',
